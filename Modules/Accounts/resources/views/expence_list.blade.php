...
<div class="filter-card">
    ...
    <form method="GET" action="{{ route('accounts.expence_list') }}">
...
@php
    ...
    $status  = $requests->c_status;
@endphp

{{-- ================= OWN REQUEST ================= --}}
@if($adminId == $requests->n_user_id)
...
@elseif($adminId == 1)
    ...
    @if($status == 'P')
        <a href="javascript:void(0);"
           data-url="{{ route('accounts.approve_request_expence', ['id' => $requests->n_slno]) }}"
           class="btn-approve approve-btn">
            Approve
        </a>

        <a href="javascript:void(0);"
           data-url="{{ route('accounts.reject_request_expence', ['id' => $requests->n_slno]) }}"
