...
<div class="filter-card">
    ...
    <form method="GET" action="{{ route('accounts.approve_list_sub') }}">
        ...
        <tbody>
          ...
          @foreach($db as $requests)
            ...
            <tr>
             ...
             <td>
                @if($requests->c_superadmin_status == 'approved' && $requests->c_admin_status == 'approved')
                    Approved

                @elseif($requests->c_admin_status == 'approved')
                    Admin Approved
